...
import { SubscribtionCard } from "./SubscriptionCard"
import { ManualGoldEditDialog } from "./ManualGoldEditDialog"
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2">
      {Array.from({ length: 4 }).map((_, i) => (
        <Skeleton key={i} className="h-45 rounded-[60px]" />
      ))}
    </div>
  )
}
...
export default function Dashboard({ loc }: { loc: "admin" | "user" }) {
  ...
  return (
    <div className="p-2 md:p-6 space-y-3">
      ...
      <MyCard title="Altın Türleri" Icon={BorderFullFilled} >
        {isLiveDataLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2">
            ...
            <div className="relative overflow-hidden rounded-[60px] squircle border p-3 transition-all hover:shadow-md hover:scale-[1.02] bg-my-lavender2">
              <div className="">
                <div className="w-full flex items-center justify-between">
                  <div className="flex items-center gap-x-2">
                    <div className="p-3 rounded-full bg-white/40">
                    ...
                    <Select value={selectedGold} onValueChange={setSelectedGold as (value: string) => void}>
                      ...
                      <SelectContent>
                        <SelectItem value="quarter">Çeyrek Altın</SelectItem>
                        <SelectItem value="half">Yarım Altın</SelectItem>
                        <SelectItem value="full">Tam Altın</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  {/* <div className="p-3 rounded-full bg-white/40">
            ...
            <div className="relative overflow-hidden rounded-[60px] squircle border  p-3 transition-all hover:shadow-md hover:scale-[1.02] bg-my-pink">
              <div className="">
                <div className="w-full flex items-center justify-between">
                  <div className="flex items-center gap-x-2">
                    <div className="p-3 rounded-full bg-white/40">
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className={cn("col-span-3  flex flex-col gap-3", loc === "user" ? "md:col-span-2" : "md:col-span-3")}>
          <div className="w-full md:h-1/2">
            <MyCard
              title="Altın Fiyat Grafiği"
              Icon={ChartLineDataFilled}
              expandable={true}
              modalStyle="min-w-screen md:min-w-200"
              actions={
              ...
              {isManualGoldLoading ? (
                ...
                return (
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
                    {/* Gram Alış */}
                    <div className="relative overflow-hidden rounded-[60px] squircle border bg-my-orange p-3 transition-all hover:shadow-md hover:scale-[1.02] ">
                      <div className="w-full flex items-center justify-between">
                        <div className="flex items-center gap-x-2">
                          <div className="p-3 rounded-full bg-white/40">
                    ...
                    {/* Gram Satış */}
                    <div className="relative overflow-hidden rounded-[60px] squircle border p-3 transition-all hover:shadow-md hover:scale-[1.02] bg-my-blue">
                      <div className="w-full flex items-center justify-between">
                        <div className="flex items-center gap-x-2">
                          <div className="p-3 rounded-full bg-white/40">
                    ...
                    {/* Selector card */}
                    <div className="relative overflow-hidden rounded-[60px] squircle border p-3 transition-all hover:shadow-md hover:scale-[1.02] bg-my-lavender">
                      <div className="w-full flex items-center justify-between">
                        <div className="flex items-center gap-x-2">
                          <div className="p-3 rounded-full bg-white/40">
                            <GoldIngotsFilled className="size-4" />
