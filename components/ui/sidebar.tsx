    ...
    >
      ...
      >
        <div
          ...
          className=" group-data-[variant=floating]:border group-data-[variant=floating]:border-white  group-data-[variant=floating]:bg-white/40 group-data-[variant=floating]:backdrop-blur-2xl group-data-[variant=floating]:rounded-[30px]  group-data-[variant=floating]:squircle group-data-[variant=floating]:ring-sidebar-border group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:ring-1 flex size-full flex-col"
        >
          {children}
        </div>
      </div>
