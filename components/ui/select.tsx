...
import { ArrowDown01Sharp, ArrowUp01Sharp, Tick02, UnfoldMoreSharp } from "asem-icons"
  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <UnfoldMoreSharp strokeWidth={2} className="text-muted-foreground size-4 pointer-events-none" />
...
function SelectScrollDownButton({
  ...
  return (
    <SelectPrimitive.ScrollDownButton
      ...
      {...props}
    >
      <ArrowDown01Sharp strokeWidth={2} />
    </SelectPrimitive.ScrollDownButton>
  )
}
